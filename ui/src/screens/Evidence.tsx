    ...
    <div>
      <div className="flex flex-wrap items-baseline justify-between gap-2 no-pack">
        ...
        <div className="flex flex-wrap items-center gap-2 no-print">
          ...
          <button type="button" onClick={() => printAs("pack")} className="btn btn-primary">Print evidence pack</button>
...
function PackHeader() {
  ...
  return (
    <header className="border-b border-line pb-2 mb-4">
      <div className="text-[17px] font-semibold text-navy">{r.repository.name} · AI agent evidence pack</div>
          ...
          <ol className="m-0 p-0 list-none panel divide-y divide-line">
            {fixes.map((f, i) => (
              <li key={`${f.rule_id}-${i}`} className="p-3 grid gap-x-4 gap-y-1 md:grid-cols-[28px_1fr_1fr] text-[13px]">
                <span className="num text-navy text-[20px] leading-none tabular-nums">{i + 1}</span>
                <div>
