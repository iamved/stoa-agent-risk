...
export const OWASP_LLM_2025: { code: string; name: string; description: string }[] = [
  ...
  { code: "LLM06", name: "Excessive Agency", description: "The agent has more functionality, permissions, or autonomy than its task needs." },
...
export const EU_AI_ACT_DESCRIPTIONS: Record<string, string> = {
  ...
  "Art. 14": "People must be able to oversee the system and step in.",
